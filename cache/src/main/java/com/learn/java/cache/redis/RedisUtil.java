...
import com.learn.java.cache.util.PropertyUtils;
...
public class RedisUtil {
    ...
    private PropertyUtils propertyUtils = PropertyUtils.getUtil(configPath);

    /**
     * 构造redis 连接客户端
     */
    private RedisUtil() {
        String ip = propertyUtils.getString("redis.host");
        Integer port = propertyUtils.getInt("redis.port");
        String password = propertyUtils.getString("redis.password");

        JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
        jedisPoolConfig.setMaxTotal(propertyUtils.getInt("redis.maxTotal"));
        jedisPoolConfig.setMaxIdle(propertyUtils.getInt("redis.maxIdle"));
        jedisPoolConfig.setMaxWaitMillis(propertyUtils.getLong("redis.maxWaitMillis"));
        jedisPoolConfig.setTestOnBorrow(propertyUtils.getBoolean("redis.testOnBorrow"));
